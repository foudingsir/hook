...
void EngineInit(HWND hWnd)
{
	...
	GName = (uint8_t**)(GameBase + 0x7C59280);
	GWorld = (UWorld**)(GameBase + 0x7E49140);

	_Spawn = (GameBase + 0x22A20C0);
	_GetBoneMatrix = (fn_GetBoneMatrix)(GameBase + 0x49F73F0);
	_LineTraceSingle = (fn_LineTraceSingle)(GameBase + 0x4BEA600);
	_GetForwardVector = (fn_GetForwardVector)(GameBase + 0xA35540);
	_ProjectWorldLocationToScreen = (fn_ProjectWorldLocationToScreen)(GameBase + 0x4E67300);
}
